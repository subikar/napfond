...
class Mage_Adminhtml_Block_Sales_Order_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        if ($this->_isAllowedAction('underprocessing')) {
			
			
			if($order->getStatus() == "under_processing"){
            $this->_addButton('order_under_processing', array(
                'label'     => Mage::helper('sales')->__('Under Processing'),
                'onclick'   => 'alert(\'Order is already set to processing.\')',
				'disabled'   => 'disabled',
            ...
            $this->_addButton('order_under_processing', array(
                'label'     => Mage::helper('sales')->__('Under Processing'),
                'onclick'   => 'setLocation(\'' . $this->getUnderProcessingUrl() . '\')',
    ...
    public function getUnderProcessingUrl()
    {
        return $this->getUrl('*/*/underprocessing');
    }
