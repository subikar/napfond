 ...
 */
class GoMage_ProductDesigner_Model_Fontswithcat extends Mage_Core_Model_Abstract {
    /**
     * Entity code.
    ...
    {
        $this->_init('gomage_designer/fontswithcat');
    }
    ...
    {
        return Mage::getSingleton('gomage_designer/fontswithcat_gallery_config');
    }
