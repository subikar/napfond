 ...
 */
class GoMage_ProductDesigner_Adminhtml_FontswithcatsController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $category = Mage::getModel('gomage_designer/fontswithcat_category');
        ...
        if ($this->getRequest()->getQuery('isAjax')) {
            ...
            $clipartBlock = $this->getLayout()->getBlock('fontswithcats_edit');
			
			//echo $clipartBlock->getFormHtml();
			//exit;
            $eventResponse = new Varien_Object(array(
                'content' => $clipartBlock->getFormHtml()
                    . $this->getLayout()->getBlock('fontswithcats_categories_tree')
    ...
    public function deleteAction()
    {
        if ($id = (int) $this->getRequest()->getParam('id')) {
            try {
                $category = Mage::getModel('gomage_designer/fontswithcat_category')->load($id);
                ...
                if(count($images) > 0) {
                    foreach($images as $image) {
                        if(!empty($image)) {
							...
							$fontPath = $fontObj->getFontPath($image['url']);
							
                            $fontObj->setData(array(
                                'font_id' => @$image['value_id'],
    ...
    public function categoriesJsonAction()
    {
        ...
        if ($categoryId = (int) $this->getRequest()->getPost('id')) {
            ...
            $this->getResponse()->setBody(
                $this->getLayout()->createBlock('gomage_designer/adminhtml_fontswithcats_tree')
