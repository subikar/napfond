...
class Mage_Adminhtml_Block_Sales_Order_Shipment_View_Tracking extends Mage_Adminhtml_Block_Template
{
    ...
    public function getCancelShipmentUrl($trknumber)
    {
        return $this->getUrl('*/sales_order_shipment/cancelshipment', array('track_id'  => $trknumber,'shipment_id' => $this->getShipment()->getId()));
    }
