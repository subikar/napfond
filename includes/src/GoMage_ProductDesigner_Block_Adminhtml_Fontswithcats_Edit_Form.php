 ...
 */
class GoMage_ProductDesigner_Block_Adminhtml_Fontswithcats_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    public function getDefaultCategoryId() {
        ...
        $clipartsCategorySingleton = Mage::getSingleton('gomage_designer/fontswithcat_category');
