 ...
 */
class Ikantam_InstagramConnect_Model_Source_Instagram_User extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
    /**
    ...
    public function getAllOptions()
    {
        if (is_null($this->_options)) {
            $users  = explode(',', Mage::getStoreConfig('ikantam_instagramconnect/module_options/users'));
