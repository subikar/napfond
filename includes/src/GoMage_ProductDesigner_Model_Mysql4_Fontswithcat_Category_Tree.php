 ...
 */
class GoMage_ProductDesigner_Model_Mysql4_Fontswithcat_Category_Tree
    extends Mage_Catalog_Model_Resource_Eav_Mysql4_Category_Tree
{
    public function __construct()
    {
        ...
        $table = $resource->getTableName('gomage_designer/fontswithcat_category');
        $fields = array(
    ...
    public function addJoin($select) {
        ...
        $categoriesTable         = Mage::getSingleton('core/resource')->getTableName('gomage_designer/fontswithcat_category');
        $categoriesProductsTable = Mage::getSingleton('core/resource')->getTableName('gomage_designer/font');
