...
/////////////////////////////////////////////////Code for calculating grand total//////////////////////////////////////////////
                      ...
                      $orderItem = $read->query("SELECT `item_id`, `product_id`, `price`, `row_total`, `discount_amount`, `discount_percent`, `cod_applicable` FROM `sales_flat_order_item` WHERE `order_id` = '".$order_id."' AND `product_type` = 'configurable'");
                        $allOrderItem = $orderItem->fetchAll();
