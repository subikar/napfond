...
//////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
            ...
            if (!$this->getSkipJsReloadPrice()) {
                $extraParams .= ' onchange="chk_custom(this.options[this.selectedIndex].text);opConfig.reloadPrice()"';
            }
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            $arraySign = '';//echo $_option->getPrice();
...
/////////////////////////////////////New Customize Code////////////////////////////////////////				
				...
				$main_price = $_value->getOption()->getProduct()->_data['price'];
				
				$main_price2 = $_value->getOption()->getProduct()->_data['final_price'];
				 
				
				if($main_price2 && $main_price2 < $main_price)
				{
                $priceStr = $this->_formatPrice(array(
                    'is_percent'    => ($_value->getPriceType() == 'percent'),
                    'pricing_value' => $_value->getPrice(($_value->getPriceType() == 'percent')),
                ...
                $priceStr2 = $this->_formatPrice(array(
                    'is_percent'    => ($_value->getPriceType() == 'percent'),
                    'pricing_value' => $_value->getPrice(($_value->getPriceType() == 'percent')),
					'is_price' => ($main_price2-lowestCustomOptionPriceDifference)
                ),false);
				
				
$priceStr_String = '<div class="price-box"><p class="old-price"><span class="price">'.$priceStr.'</span></p><p class="special-price"><span class="price">'.$priceStr2.'</span></p></div>';
				}else{
					
					
                $priceStr_String = $this->_formatPrice(array(
                    'is_percent'    => ($_value->getPriceType() == 'percent'),
                    'pricing_value' => $_value->getPrice(($_value->getPriceType() == 'percent')),
					'is_price' => $main_price
                ),false);
...
/////////////////////////////////////////////////////////////////////////////////////////////////				
				...
				if($_value->getTitle() == 'Back'){$checked = 'checked="checked"';}
                ...
                $selectHtml .= '<li>' . '<input type="' . $type . '" class="' . $class . ' ' . $require
                    ...
                    . $_value->getTitle() . ' ' . $priceStr_String . '</label></span>';
                if ($_option->getIsRequire()) {
