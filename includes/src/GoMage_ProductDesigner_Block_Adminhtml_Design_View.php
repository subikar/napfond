...
class GoMage_ProductDesigner_Block_Adminhtml_Design_View extends Mage_Adminhtml_Block_Widget_Container
{
     ...
     * @return GoMage_ProductDesigner_Model_Mysql4_Design_Image_Collection
     */
    public function getUploadedImagesCollection($gravitaSessionId)
    {
        return $this->_initUploadedImagesCollection($gravitaSessionId);
    }
     ...
     * @return GoMage_ProductDesigner_Model_Mysql4_Design_Collection
     */
    protected function _initUploadedImagesCollection($gravitaSessionId)
    {
    ...
    {
        return stripslashes(Mage::helper('gomage_designer/image_design')->init($image)->resize($size));
    }
