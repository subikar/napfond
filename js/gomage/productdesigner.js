...
GoMage.ProductDesigner.prototype = {
    ...
    addDesignArea : function(prod) {
		...
		if(1){
				jQuery(".lower-canvas").css( "left", "-35px" );
				jQuery(".lower-canvas").css( "top","-55px" );
				
				jQuery(".upper-canvas").css( "left", "-35px" );
				jQuery(".upper-canvas").css( "top","-55px" );
			
				jQuery(".canvas-container").css( "width", prod.w+"px" );
				jQuery(".canvas-container").css( "height",prod.h+"px" );
				
				jQuery("#pd_container").css( "width", "400px" );
				jQuery("#pd_container").css( "height","400px" );
 ...
 this.canvas.setOverlayImage('http://dev.gravitainfotech.com:8282/projects/Active/jazzy1/media/stock/img-600/Auto%20and%20transportation/-27.jpg', this.canvas.renderAll.bind(this.canvas), {
    ...
    saveDesign: function(url, responseCallback){
		...
		if(tshirtColorName != ''){
			...
			objCallDirectForCanvas.overlayImage.src = folderUrl+'/resized/for_customizer/without-inner-border/'+printAreaFolderName+'/'+tshirtColorName+'/mask.png';		
			objCallDirectForCanvas.setOverlayImage(folderUrl+'/resized/for_customizer/without-inner-border/'+printAreaFolderName+'/'+tshirtColorName+'/mask.png', objCallDirectForCanvas.renderAll.bind(objCallDirectForCanvas), {
					overlayImageLeft: 0,
					overlayImageTop: 0
			});
...
jQuery("#pd_save_design_span1 > span").Loadingdotdotdot({
    ...
    "word": ""
		...
		if(tshirtColorName != ''){		
			objCallDirectForCanvas.overlayImage.src = folderUrl+'/resized/for_customizer/'+printAreaFolderName+'/'+tshirtColorName+'/mask.png';		
			objCallDirectForCanvas.setOverlayImage(folderUrl+'/resized/for_customizer/'+printAreaFolderName+'/'+tshirtColorName+'/mask.png', objCallDirectForCanvas.renderAll.bind(objCallDirectForCanvas), {
					overlayImageLeft: 0,
					overlayImageTop: 0
			});
			objCallDirectForCanvas.renderAll.bind(objCallDirectForCanvas);
