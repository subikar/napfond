 ...
 */
class GoMage_ProductDesigner_Block_Adminhtml_Fontswithcats_Tree extends Mage_Adminhtml_Block_Catalog_Category_Abstract
{
    ...
    public function getCategoryCollection()
    {
        ...
        if (is_null($collection)) {
            ...
            Mage::getResourceSingleton('gomage_designer/fontswithcat_category_tree')->addJoin($collection->getSelect());
...
//        );
    ...
    public function getRoot($parentNodeCategory=null, $recursionLevel=3)
    {
        ...
        if (is_null($root)) {
            ...
            $tree = Mage::getResourceSingleton('gomage_designer/fontswithcat_category_tree')
    ...
    {
        $tree = Mage::getResourceModel('gomage_designer/fontswithcat_category_tree');
    ...
    public function getBreadcrumbsJavascript($path, $javascriptVarName)
    {
        ...
        $categories = Mage::getResourceSingleton('gomage_designer/fontswithcat_category_tree')
