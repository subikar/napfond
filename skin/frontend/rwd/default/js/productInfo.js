...
ProductInfo.prototype = {
    ...
    createWindow: function()
    {
        ...
        qWindow.innerHTML = '<div id="quickview-header"><a href="javascript:void(0)" id="quickview-close"><i class="fa fa-arrows-alt fa-lg"></i></a></div><div class="quick-view-content"></div>';
