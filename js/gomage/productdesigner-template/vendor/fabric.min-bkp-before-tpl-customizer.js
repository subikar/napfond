            ...
            setCoords: function () {
                ...
                var i = Math.sqrt(Math.pow(this.currentWidth / 2, 2) + Math.pow(this.currentHeight / 2, 2)),
					...
					for (var property in this) {
						...
						if(property != 'oCoords')
							continue;
					 for(var property2 in this[property])
					  {
						 for(var property3 in this['oCoords'][property2])
						  {  if(property3 != 'corner')
								continue;
							 for(var property4 in this['oCoords'][property2][property3])
							  {     
									alert(property4 + " = " +this['oCoords'][property2][property3][property4])
									alert(jQuery(property4).zIndex())
									alert(jQuery(property4).position())
									alert(jQuery(property4).offset())
								for(var property5 in this['oCoords'][property2][property3][property4])
									{   
							alert(property5 + " = " +this['oCoords'][property2][property3][property4][property5])  
										//jQuery(this['oCoords'][property2][property3]).css( "display", 'none' )
									}		
							  }		
						  }	
					  }
				...
				//jQuery(this["oCoords"]['tl']).hide();
					/*jQuery("#exclude_front_img_div").append("<div style='position:absolute;z-index:500055;background:#000;top:"+c.x+";left:"+c.y+";'>test</div>")*/
