...
class Mage_Checkout_Model_Type_Onepage
{
    ...
    public function __construct()
    {
        ...
        $this->_customerEmailExistsMessage = Mage::helper('checkout')->__('This email id already registered with us. Please enter your password to continue.');
        $this->_checkoutSession = Mage::getSingleton('checkout/session');
        $this->_customerSession = Mage::getSingleton('customer/session');
		
		////CODE TO UPDATE THE PRODUCT NAME IN CART//////////////////////
			Mage::helper('function/more')->updateProductsNameInCart();
		/////////END CODE//////////////////////////////////////////////// 
        ...
        if ($customer->isConfirmationRequired()) {
            ...
            $this->getCustomerSession()->addSuccess(
                Mage::helper('customer')->__('Account confirmation is required. Please, check your e-mail for confirmation link. To resend confirmation email please <a href="%s">click here</a>.', $url)
								...
								$subscriber = Mage::getModel('newsletter/subscriber')->subscribe($customer->getEmail());
