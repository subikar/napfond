...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
{
    ...
    public function sendNewAccountEmail($type = 'registered', $backUrl = '', $storeId = '0')
    {
		...
		if(Mage::app()->getRequest()->getParam('fromFrontRegisterForm') == "yes"){
...
$emailTemplateVariables['tname'] = $_POST['firstname'];
$emailTemplateVariables['temail'] = $_POST['email']; 
$emailTemplateVariables['password'] = $_POST['password'];
//$emailTemplateVariables['email'] = 'test';
...
$emailTemplate->setSenderName('Bhishoom');
            ...
            $emailTemplate->setTemplateSubject('Welcome to Bhishoom.com');
             

		
	 $emailTemplate->send($receiveremail,$senderName, $emailTemplateVariables);		
		}	
		else 
