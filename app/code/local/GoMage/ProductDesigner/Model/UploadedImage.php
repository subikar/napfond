...
class GoMage_ProductDesigner_Model_UploadedImage extends Mage_Core_Model_Abstract
{
    ...
    public function getUploadedImageCollectionByGravitaSession($gravitaSessionId)
    {
 
            $uploadedSessionImages = $this->_getUploadedImagesFromGravitaSession($gravitaSessionId)->getItems();
            $uploadedImages = $uploadedSessionImages;
    ...
    protected function _getUploadedImagesFromGravitaSession($gravitaSessionId)
    {
        /**
         * @var $collection GoMage_ProductDesigner_Model_Mysql4_UploadedImage_Collection
         */
       // $designerSessionId = $this->_getDesignerSessionId();
        $collection = $this->getResourceCollection();
        $collection->addFieldToFilter('gravita_custom_session_id', $gravitaSessionId);
