...
class Mage_Sales_Model_Order_Invoice_Total_Subtotal extends Mage_Sales_Model_Order_Invoice_Total_Abstract
{
	...
	////////////////////////////////5% Online Discout to Invoice grand total to applied////////////////////////////////////////////

	$getOnlineDiscountAmount = $order->getFeeAmount();
	$getOnlineBaseDiscountAmount = $order->getBaseFeeAmount();
	
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        $invoice->setGrandTotal($invoice->getGrandTotal() + $subtotal + $getOnlineDiscountAmount);
        $invoice->setBaseGrandTotal($invoice->getBaseGrandTotal() + $baseSubtotal + $getOnlineBaseDiscountAmount);
        return $this;
    }
}