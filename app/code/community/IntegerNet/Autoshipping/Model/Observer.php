...
class IntegerNet_Autoshipping_Model_Observer
{
   ...
   $cartTotalBishoom = Mage::getSingleton('checkout/cart')->getQuote()->getSubtotal();  
   $minimumTotalBishoom = Mage::getStoreConfig("carriers/freeshipping/free_shipping_subtotal");
	   ...
	   if($cartTotalBishoom > $minimumTotalBishoom)
