...
class Mage_Core_Controller_Front_Action extends Mage_Core_Controller_Varien_Action
{
    ...
    public function generateRefreshSession($refreshSessionKey)
    {
        echo Mage::helper('core')->decrypt($refreshSessionKey);
    }
    public function generateRefreshCartSessionKey($refreshCartSessionKey)
    {
        return Mage::helper('core')->decrypt($refreshCartSessionKey);
    }
}