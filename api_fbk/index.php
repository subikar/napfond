...
parent.jQuery('#uploadedImages_fb_img').attr('data-origin-url',data_origin_url);
                        ...
                        var new_id = ("uploadedImages_fb_img");    
                        parent.document.getElementById(new_id).dispatchEvent(evt);*/
