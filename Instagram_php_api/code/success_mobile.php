...
$instagram = new Instagram(array(
  ...
  'apiCallback' => Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB).'Instagram_php_api/code/success_mobile.php' // must 
  ));
...
window.close();
//window.opener.location.href='images_mobile.php';
</script>";
?>