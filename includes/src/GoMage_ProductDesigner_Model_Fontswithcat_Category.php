 ...
 */
class GoMage_ProductDesigner_Model_Fontswithcat_Category extends Mage_Core_Model_Abstract {

    /**
     * Entity code.
     * Can be used as part of method name for entity processing
     */
    const ENTITY                = 'fontswithcat_category';

    /**
     * Model cache tag
     */
    const CACHE_TAG             = 'designer_fontswithcats_category';
    ...
    {
        $this->_init('gomage_designer/fontswithcat_category');
    }
    ...
    {
        $collection = Mage::getResourceModel('gomage_designer/fontswithcat_collection');
    ...
    {
        $collection = Mage::getResourceModel('gomage_designer/fontswithcat_category_collection');
    ...
    public function move($parentId, $afterCategoryId)
    {
         ...
         */
        $parent = Mage::getModel('gomage_designer/fontswithcat_category')
