...
Payment.prototype = {
    ...
    beforeInit : function() {
		var curr_id = jQuery('.active').attr('id');		
		if(curr_id == 'opc-payment')
		{	
			var hj = jQuery('#checkoutSteps > #opc-payment > #checkout-step-payment').innerHeight();
			var hj = hj + 110;
			jQuery('#checkoutSteps').css({'height': hj});
		}
...
Review.prototype = {
    initialize: function(saveUrl, successUrl, agreementsForm){
        ...
        this.onSave = this.nextStep.bindAsEventListener(this);
        this.onSave2 = this.nextStep2.bindAsEventListener(this);
        this.onComplete = this.resetLoadWaiting.bindAsEventListener(this);
		var curr_id = jQuery('.active').attr('id');
