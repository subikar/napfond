 ...
 */
class GoMage_ProductDesigner_Model_Mysql4_Fontswithcat_Category extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {
        $this->_init('gomage_designer/fontswithcat_category', 'category_id');
    }
