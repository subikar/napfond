...
class Mage_Catalog_Model_Category extends Mage_Catalog_Model_Abstract
{
    ...
    public function getProductCollection()
    {
		/* 
		if($this->getId() == 24){
		$collection = Mage::getResourceModel('catalog/product_collection')->joinField('category_id', 'catalog/category_product', 'category_id', 'product_id = entity_id', null, 'left')
            ...
            ->setStoreId($this->getStoreId())
            ->addCategoryFilter($passCatIdObjTablet);
		}	   
		else*/
        $collection = Mage::getResourceModel('catalog/product_collection')
            ->setStoreId($this->getStoreId())
    ...
    {	
		return rtrim($this->getUrlModel()->getCategoryUrl($this),'/');
    }
